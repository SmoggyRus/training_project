                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?=$user['status']?> mr-3">
                                    ...
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?=$user['image']?>'); background-size: cover;"></span>
                                    <?php else:?>
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="page_profile.php?id=<?=$user['id']?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?=$user['username']?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="app/delete.php?id=<?=$user['id']?>" class="dropdown-item" onclick="return confirm('Вы действительно хотите удалить этого пользователя?');">
